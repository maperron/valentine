...
const EscapingButton: React.FC = () => {
  ...
  return (
    <button
      ...
      onTouchStart={(e) => {
        // Stop default to prevent clicking before move
        e.preventDefault();
        moveButton();
      }}
      style={{
      ...
      className="w-32 py-3 bg-white text-black font-bold rounded-full shadow-lg border-2 border-transparent hover:border-red-500 active:scale-95 z-50 pointer-events-auto flex items-center justify-center touch-none select-none"
